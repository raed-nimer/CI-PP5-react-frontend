...
| As a user, I want to be able to easily log in and log out of my account.                  | Login and Logout buttons are in the navbar and available on all pages. The logout button is included inside a dropdown.                    | ![Login button](public/readme-images/Testing-login.png) ![Logout button](/staticfiles/readme-images/manual-testing/Testing-logout.png) |
